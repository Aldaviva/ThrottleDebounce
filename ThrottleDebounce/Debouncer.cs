...
/// <summary>Create a proxy delegate that debounces the given real delegate, dropping invocations that occur too many times in an interval. Unlike throtting, debouncing will not execute the delegate at all in the face of a constant stream of invocations.</summary>
/// <seealso cref="Throttler"/>
public static class Debouncer {

    /// <summary>
    /// Create a proxy action that debounces <paramref name="action"/>, dropping all but the latest of the invocations that occur too many times in <paramref name="wait"/>. Unlike throtting, debouncing will not execute the delegate at all in the face of a constant stream of invocations.
    /// </summary>
    ...
    /// <summary>
    /// Create a proxy function that debounces <paramref name="func"/>, dropping all but the latest of the invocations that occur too many times in <paramref name="wait"/>. Unlike throtting, debouncing will not execute the delegate at all in the face of a constant stream of invocations.
    /// </summary>
    ...
    /// <inheritdoc cref="Debounce{T}(Func{T},TimeSpan,bool,bool)" />
